...
class HabitDetailViewController: UIViewController {
  ...
  var habitStatististicsRequestTask: Task< Void, Never>? = nil
  deinit {habitStatististicsRequestTask?.cancel()}
  ...
  func update() {
    habitStatististicsRequestTask?.cancel()
    habitStatististicsRequestTask = Task {
      ...
      habitStatististicsRequestTask = nil
    }
  }
